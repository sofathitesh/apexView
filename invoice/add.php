    ...
    <div class="box-body">
        ...
        <div class="row">
            ...
            <div class="col-sm-12">
                ...
                <form class="form-horizontal" role="form" id="add_frm" method="post" onsubmit="return false;">
                    ...
                    ?>
                        ...
                        <div class="col-sm-4">
                            ...
                            <input type="number" class="form-control" id="item_no" name="item_no" value="<?=set_value('item_no')?>" min="0">
                    ...
                    ?>
                       ...
                       <!-- <label for="invoice_no" class="col-sm-4 control-label">
                        ...
                        <div class="col-sm-4">
                            ...
                            <input type="text" class="form-control" id="invoice_no" name="invoice_no" value="<?=set_value('invoice_no')?>" >
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-offset-2 col-sm-8">
                            ...
                            <input type="submit" class="btn btn-success" onclick="btn_add();" value="<?=$this->lang->line("add_invoice")?>" >
